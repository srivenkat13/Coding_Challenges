...
# Write a program which displays the multiplication table and exponential table for any given number. Each table should   show mathematical results for operations performed  with the number in range of 1 to 9.
# then print series of messages telling how cool the mathematics truly is

# greet the user with welcome message
# to escape the backslash use it twice
print("Welcome the Multiplication\\Exponent Table App")

# get the name of user
name = input("What is your name:").title().strip()

# get the user input for their number
num = float(input("What number would you like to work with:"))

# message for printing at the end
